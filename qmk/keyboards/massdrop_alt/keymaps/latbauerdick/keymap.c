...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_65_ansi_blocker( /* Colemak wide layout */
        ...
        KC_LSFT, KC_X   , KC_C   , KC_D   , KC_V   , KC_Z   , KC_SLSH, KC_K   , KC_H   , KC_COMM, KC_DOT , RSF_SLS,          XXXXXXX, KC_ENT , \
    ...
    [_QWERTY] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LALT, GUI_DEL,                            RSE_SPC,                            GUI_RET, ADJ_SPC, KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
