...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT( /* QWERTY */
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_V,    \
      ...
      MO(_RAISE),KC_LALT, GUI_DEL,                            LOW_SPC,                            GUI_RET, MO(_ADJ),KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [_COLEMAK] = LAYOUT( /* Colemak */
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, KC_Q   , KC_W   , KC_F   , KC_P   , KC_B   , KC_J   , KC_L   , KC_U   , KC_Y   , KC_SCLN, _______, _______, _______, KC_D   , \
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_QUOT,          _______, _______, \
        _______, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_LPRN, KC_RPRN, KC_QUOT, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______  \
    ),
    [_RAISE] = LAYOUT(
        KC_GRV , _______, _______, _______, _______, _______, _______, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, _______, _______, _______, \
        KC_GRV , _______, _______, _______, _______, _______, _______, KC_7   , KC_8   , KC_9   , KC_ASTR, KC_SLSH, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, KC_4   , KC_5   , KC_6   , KC_PLUS, KC_MINS,          _______, _______, \
    ...
    [_NAV] = LAYOUT(
        ...
        _______, XXXXXXX, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, _______,          _______, _______, \
        _______, XXXXXXX, XXXXXXX, KC_D   , XXXXXXX, XXXXXXX, KC_BSPC, KC_LEFT, XXXXXXX, KC_VOLD, KC_VOLU, _______,          _______, _______, \
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______  \
    ),
    [_ADJ] = LAYOUT( /* Adjust */
